...
export const PaginaPesquisa = () => {
    return (
        <div className='absolute inset-0 scroll-smooth flex md:flex-row flex-col'>
            ...
            <div className="relative bg-[#FDF3ED] md:w-2/5 h-full shadow-2xl z-10 shadow-[#f15a386b]">
                <div className='mt-8 ml-10'>
                    ...
                    <div className='flex flex-col items-start pl-5 pt-5 text-xl accent-[#3E7A68]'>
                        ...
                        <button type='button' className='bg-[#F15A38] flex justify-center items-center w-10 h-10 absolute top-2/4 -right-5 rounded-full shadow shadow-md shadow-[#b15c44]'>
